...
lib.ssMetadata = [
		{name:"PR_IdeaPad_5i_2_in_1_CM_GDN_728x90_atlas_1", frames: [[0,736,50,50],[0,0,728,90],[0,92,728,90],[0,184,728,90],[0,276,728,90],[0,368,728,90],[0,460,728,90],[0,552,728,90],[0,644,728,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_IdeaPad_5i_2_in_1_CM_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRIdeaPad5i2in1CMGDN728x90 = function(mode,startPosition,loop,reversed) {
...
// library properties:
lib.properties = {
	id: '3514B66AEE9FD149B11F8F4F0C68C0D9',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_IdeaPad_5i_2_in_1_CM_GDN_728x90_atlas_1.png", id:"PR_IdeaPad_5i_2_in_1_CM_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['3514B66AEE9FD149B11F8F4F0C68C0D9'] = {
